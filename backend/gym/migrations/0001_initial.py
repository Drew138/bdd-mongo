    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lista_equipos', models.CharField(blank=True, max_length=255, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Zona',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clases', models.ManyToManyField(blank=True, to='gym.Clase')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zona', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gym.zona')),
            ],
        ),
        migrations.AddField(
            model_name='clase',
